...
func (e *Engine) runRoutingStage(
	...
	if isExecutorStep(step) && stepHoldsTree(spec) {
		...
		//
		// THE RETAINED RECORD'S TARGET STANDS TOO. A retry that
		...
		// head, since it stands at its base. Re-recording the retained
		...
		// target advisory acquits; moving the target on
